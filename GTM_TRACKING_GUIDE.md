...
```javascript
{
  ...
  'step_name': 'step_1',          // ステップ名（step_1, step_2, step_3, confirmation）
  'step_number': 1                // ステップ番号（1, 2, 3, 4）
}
```
